...
public class Mydatabase extends SQLiteOpenHelper {
    ...
    public static final String TB_DHC = "donghoco";
    public static final String TB_DHDT = "donghodientu";
    public static final String TB_DHTM = "donghothongming";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(createTables(TB_DHTM));
        sqLiteDatabase.execSQL(createTables(TB_DHDT));
        sqLiteDatabase.execSQL(createTables(TB_DHC));
